...
function App() {
  ...
  return (
    <Router>
      <Navigation />
      {user && !user.isVerified && user.role !== 'child' &&user.role !== 'admin' && <VerificationBanner />}
      <div className="container mx-auto  bg-white ">
        <Routes>
          ...
          <Route path="/module/:moduleId" element={
            <ProtectedRoute allowedRoles={["parent", "child", "therapist", "admin"]}>
              <ModuleDetail />
            </ProtectedRoute>
          } />
          ...
          <Route path="/interactive-session" element={
